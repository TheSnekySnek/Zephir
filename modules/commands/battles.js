...
if (ADB.getBattleSettings().enabled) {
    module.exports = {
        ...
        dungeon: async function (message, command, args) {
            ...
            if (mob.icon != "A Link") {
                mob.icon = "https://cdn.discordapp.com/attachments/233701911168155649/490541818090487808/Mob_Icon_Default_NoBg.png"
            }
            ...
            let embed = new Discord.RichEmbed()
                ...
                .setColor("#dcbc3f")
                .setThumbnail(mob.icon)
                .addField("Monster Bio:", mob.bio)
                ...
                collector.on('collect', r => {
                    switch (r.emoji.name) {
                        case "💙":
                            ...
                            message.member.send("You have been granted: HP +" + Math.ceil(stats.hp * items.consumable[3].hp + "%"))
                            break;
                        case "💛":
                            ...
                            message.member.send("You have been granted: HP +" + Math.ceil(stats.hp * items.consumable[4].hp + "%"))
                            break;
                        case "🗡":
                            ...
                            message.member.send("You have been granted: ATK +" + Math.ceil(stats.atk * items.consumable[5].atk + "%"))
                            break;
                        ...
                        case "🥊":
                            ...
                            message.member.send("You have been granted: ATK +" + Math.ceil(stats.atk * items.consumable[6].atk + "%"))
                            break;
                        ...
                        case "🌀":
                            ...
                            message.member.send("You have been granted: LUCK +" + items.consumable[7].luck + "%")
                            break;
                        ...
                        case "🔱":
                            ...
                            message.member.send("You have been granted: LUCK +" + items.consumable[8].luck + "%")
                            break;
